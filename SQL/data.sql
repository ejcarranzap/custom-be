...
DECLARE _UUID_MEMO CHARACTER VARYING(32) := fn_get_uuid();
/*TYPES*/
...
DECLARE AWF_UUID_COL_DISPLAY_LOGIC CHARACTER VARYING(32) := fn_get_uuid();
DECLARE AWF_UUID_COL_READONLY_LOGIC CHARACTER VARYING(32) := fn_get_uuid();
...
INSERT INTO ad_datatype VALUES(_UUID_MEMO,'0','0','MEMO','MEMO','MEMO','Y',NOW(),'0',NOW(),'0');
...
INSERT INTO ad_column VALUES(AC_UUID_COL_REF_TABLE_KEY_FIELD,'0','0',AC_UUID,_UUID_TEXT,'ref_table_key_field','Ref Key Field','Ref Key Field',NULL,'N','N',NULL,NULL,NULL,NULL,'Y',NOW(),'0',NOW(),'0');
INSERT INTO ad_column VALUES(AC_UUID_COL_REF_TABLE_TEXT_FIELD,'0','0',AC_UUID,_UUID_TEXT,'ref_table_text_field','Ref Text Field','Ref Text Field',NULL,'N','N',NULL,NULL,NULL,NULL,'Y',NOW(),'0',NOW(),'0');
...
INSERT INTO ad_column VALUES(AWF_UUID_COL_DISPLAY_LOGIC,'0','0',AWF_UUID,_UUID_MEMO,'display_logic','Display Logic','Display Logic',NULL,'N','N',NULL,NULL,NULL,NULL,'Y',NOW(),'0',NOW(),'0');
INSERT INTO ad_column VALUES(AWF_UUID_COL_READONLY_LOGIC,'0','0',AWF_UUID,_UUID_MEMO,'readonly_logic','ReadOnly Logic','ReadOnly Logic',NULL,'N','N',NULL,NULL,NULL,NULL,'Y',NOW(),'0',NOW(),'0');
/*AWF_COLUMNS*/
...
CREATE TABLE ad_menu(
	...
	MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
	CONSTRAINT parent_ad_menu FOREIGN KEY(parent) REFERENCES ad_menu(ad_menu_id)
	MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE ad_field(
	...
	position INT NOT NULL,
	isactive CHARACTER VARYING(1) CHECK(isactive IN('Y','N')),
	display_logic TEXT NOT NULL,
	readonly_logic TEXT NOT NULL,
	created TIMESTAMP NOT NULL DEFAULT NOW(),
	createdby CHARACTER VARYING(32) NOT NULL,
	updated TIMESTAMP NOT NULL DEFAULT NOW(),
	updatedby CHARACTER VARYING(32) NOT NULL,
...
INSERT INTO ad_field VALUES(AC_UUID_COL_AD_DATATYPE_ID,'0','0',AC_UUID_COL_AD_DATATYPE_ID,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'ad_datatype_id','ID datatype','ID datatype',50,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_VALUE,'0','0',AC_UUID_COL_VALUE,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'value','Code','Code',60,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_NAME,'0','0',AC_UUID_COL_NAME,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'name','Name','Name',70,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_DESCRIPTION,'0','0',AC_UUID_COL_DESCRIPTION,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'description','Description','Description',80,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_REF_TABLE,'0','0',AC_UUID_COL_REF_TABLE,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'ref_table','Ref Table','Ref Table',90,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_REF_TABLE_KEY_FIELD,'0','0',AC_UUID_COL_REF_TABLE_KEY_FIELD,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'ref_table_key_field','Ref Key','Ref Key',100,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_REF_TABLE_TEXT_FIELD,'0','0',AC_UUID_COL_REF_TABLE_TEXT_FIELD,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'ref_table_text_field','Ref Text','Ref Text',110,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_ISPK,'0','0',AC_UUID_COL_ISPK,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'ispk','IsPK','IsPK',120,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AC_UUID_COL_ISFK,'0','0',AC_UUID_COL_ISFK,_UUID_FIELD_GROUP_GENERAL,AC_UUIDT,'isfk','IsFK','IsFK',130,'Y','','',NOW(),'0',NOW(),'0');
...
INSERT INTO ad_field VALUES(AWF_UUID_COL_DISPLAY_LOGIC,'0','0',AWF_UUID_COL_DISPLAY_LOGIC,_UUID_FIELD_GROUP_GENERAL,AWF_UUIDT,'display_logic','Display Logic','Display Logic',110,'Y','','',NOW(),'0',NOW(),'0');
INSERT INTO ad_field VALUES(AWF_UUID_COL_READONLY_LOGIC,'0','0',AWF_UUID_COL_READONLY_LOGIC,_UUID_FIELD_GROUP_GENERAL,AWF_UUIDT,'readonly_logic','Readonly Logic','Readonly Logic',110,'Y','','',NOW(),'0',NOW(),'0');
/*END AWF FIELD*/
